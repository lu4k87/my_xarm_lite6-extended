    ...
    function getDevSetupActions(mode) {
      ...
      const actions = [
        ...
        { cmd: "ros2 run rviz_window_streamer rviz_window_streamer_node", title: "RViz Streamer Node" },
