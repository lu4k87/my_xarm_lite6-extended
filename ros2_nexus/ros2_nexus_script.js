    ...
    function getExtraBadge(name, pkg) {
        if (['xarm', 'lite6', 'uf_ros_lib', '_robot_driver'].some(x => name.includes(x) || pkg.includes(x))) {
            return ' <span class="badge badge-xarm" style="margin-left:4px; font-size:9px; padding:2px 4px;"><i class="fa-solid fa-robot"></i>XARM</span>';
        }
        const opt_pkgs = ['moveit_ros_move_group', 'robot_state_publisher', 'rviz2', 'rclcpp_components', 'controller_manager', 'joy', 'web_video_server', 'rosbridge_server', 'rosapi', 'octomap_server', 'tf2_ros', 'move_group', 'static_transform_publisher', 'component_container', 'spawner', 'servo_node', 'fake_components', 'joy_node'];
        if (opt_pkgs.some(x => name.includes(x) || pkg.includes(x)) || name.includes('rosbridge') || name.includes('rosapi')) {
            return ' <span class="badge badge-opt" style="margin-left:4px; font-size:9px; padding:2px 4px;"><i class="fa-solid fa-box"></i>OPT</span>';
        }
        return '';
    }
    ...
    const CMD_DETAILS = {
      ...
      "ros2 run web_video_server web_video_server --ros-args -p port:=8082": `<div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Included Source Files:</b></div><ul style="padding-left: 16px; margin: 0; font-size: 11px; color: var(--mut); line-height: 1.4;"><li><span class="badge badge-node" style="margin-right: 6px;"><svg viewBox="0 0 100 100" style="width: 10px; height: 10px; margin-right: 4px; vertical-align: -0.15em;" fill="currentColor"><g stroke="currentColor" stroke-width="8"><line x1="61.3" y1="38.7" x2="80" y2="20"/><line x1="39.7" y1="37.7" x2="25" y2="20"/><line x1="34" y1="50" x2="15" y2="50"/><line x1="50" y1="66" x2="50" y2="85"/></g><circle cx="50" cy="50" r="12" fill="none" stroke="currentColor" stroke-width="8"/><circle cx="80" cy="20" r="11" fill="currentColor"/><circle cx="25" cy="20" r="11" fill="currentColor"/><circle cx="15" cy="50" r="11" fill="currentColor"/><circle cx="50" cy="85" r="11" fill="currentColor"/></svg> NODE</span><span style="color: var(--c-node);">  web_video_server</span> <span class="badge badge-opt" style="margin-left:4px; font-size:9px; padding:2px 4px;"><i class="fa-solid fa-box"></i>OPT</span> <span style="float: right; opacity: 0.7;">(web_video_server)</span></li></ul>`,
      ...
      "ros2 run joy joy_node": `<div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Included Source Files:</b></div><ul style="padding-left: 16px; margin: 0; font-size: 11px; color: var(--mut); line-height: 1.4;"><li><span class="badge badge-node" style="margin-right: 6px;"><svg viewBox="0 0 100 100" style="width: 10px; height: 10px; margin-right: 4px; vertical-align: -0.15em;" fill="currentColor"><g stroke="currentColor" stroke-width="8"><line x1="61.3" y1="38.7" x2="80" y2="20"/><line x1="39.7" y1="37.7" x2="25" y2="20"/><line x1="34" y1="50" x2="15" y2="50"/><line x1="50" y1="66" x2="50" y2="85"/></g><circle cx="50" cy="50" r="12" fill="none" stroke="currentColor" stroke-width="8"/><circle cx="80" cy="20" r="11" fill="currentColor"/><circle cx="25" cy="20" r="11" fill="currentColor"/><circle cx="15" cy="50" r="11" fill="currentColor"/><circle cx="50" cy="85" r="11" fill="currentColor"/></svg> NODE</span><span style="color: var(--c-node);">  joy_node</span> <span class="badge badge-opt" style="margin-left:4px; font-size:9px; padding:2px 4px;"><i class="fa-solid fa-box"></i>OPT</span> <span style="float: right; opacity: 0.7;">(joy)</span></li></ul>`,
      ...
      "python3 src/dashboard_monitoring/workspace_analyzer.py": `<div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Included Source Files:</b></div><ul style="padding-left: 16px; margin: 0; font-size: 11px; color: var(--mut); line-height: 1.4;"><li><span class="badge badge-node" style="margin-right: 6px;"><svg viewBox="0 0 100 100" style="width: 10px; height: 10px; margin-right: 4px; vertical-align: -0.15em;" fill="currentColor"><g stroke="currentColor" stroke-width="8"><line x1="61.3" y1="38.7" x2="80" y2="20"/><line x1="39.7" y1="37.7" x2="25" y2="20"/><line x1="34" y1="50" x2="15" y2="50"/><line x1="50" y1="66" x2="50" y2="85"/></g><circle cx="50" cy="50" r="12" fill="none" stroke="currentColor" stroke-width="8"/><circle cx="80" cy="20" r="11" fill="currentColor"/><circle cx="25" cy="20" r="11" fill="currentColor"/><circle cx="15" cy="50" r="11" fill="currentColor"/><circle cx="50" cy="85" r="11" fill="currentColor"/></svg> NODE</span><span style="color: var(--c-node);"> workspace_analyzer.py</span> <span style="float: right; opacity: 0.7;">(Dashboard Monitoring)</span></li></ul>`,
      "python3 -m http.server 8080": `<div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Included Source Files:</b></div><ul style="padding-left: 16px; margin: 0; font-size: 11px; color: var(--mut); line-height: 1.4;"><li><span class="badge badge-server" style="margin-right: 6px;"><i class="fa-solid fa-server" style="margin-right: 4px;"></i>SERVER</span><span style="color: var(--c-cmd);"> dashboard_monitoring</span> <span style="float: right; opacity: 0.7;">(Web Server Port 8080)</span></li></ul>`,
      "python3 -m http.server 8081": `<div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Included Source Files:</b></div><ul style="padding-left: 16px; margin: 0; font-size: 11px; color: var(--mut); line-height: 1.4;"><li><span class="badge badge-server" style="margin-right: 6px;"><i class="fa-solid fa-server" style="margin-right: 4px;"></i>SERVER</span><span style="color: var(--c-cmd);"> robot_control_web_ui</span> <span style="float: right; opacity: 0.7;">(Web Server Port 8081)</span></li></ul>`
    };
          ...
          if (subCmds.length > 1) {
             ...
             subCmds.forEach(subCmd => {
                 ...
                 if (mKey) {
                     ...
                     tooltipHtml += `<li><span class="badge badge-node" style="margin-right: 6px;"><svg viewBox="0 0 100 100" style="width: 10px; height: 10px; margin-right: 4px; vertical-align: -0.15em;" fill="currentColor"><g stroke="currentColor" stroke-width="8"><line x1="61.3" y1="38.7" x2="80" y2="20"/><line x1="39.7" y1="37.7" x2="25" y2="20"/><line x1="34" y1="50" x2="15" y2="50"/><line x1="50" y1="66" x2="50" y2="85"/></g><circle cx="50" cy="50" r="12" fill="none" stroke="currentColor" stroke-width="8"/><circle cx="80" cy="20" r="11" fill="currentColor"/><circle cx="25" cy="20" r="11" fill="currentColor"/><circle cx="15" cy="50" r="11" fill="currentColor"/><circle cx="50" cy="85" r="11" fill="currentColor"/></svg> NODE</span><span style="color: var(--c-node);"> ${node}</span>${getExtraBadge(node, pkg)} <span style="float: right; opacity: 0.7;">(${pkg})</span></li>`;
                 } else if (subCmd.startsWith('(google-chrome') || subCmd.startsWith('google-chrome')) {
             ...
             tooltipHtml = `<div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Included Source Files:</b></div>
                            <ul style="padding-left: 16px; margin: 0; font-size: 11px; color: var(--mut); line-height: 1.4;">
                              <li><span class="badge badge-launch" style="margin-right: 6px;"><i class="fa-solid fa-rocket" style="margin-right: 4px;"></i>LAUNCH</span><span style="color: var(--c-launch);"> ${launchFile}</span>${getExtraBadge(launchFile, pkg)} <span style="float: right; opacity: 0.7;">(${pkg})</span>
