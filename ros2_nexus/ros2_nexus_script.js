    ...
    function getDevSetupActions(mode) {
      ...
      let zedBringupCmd = "ros2 launch my_3d_vision_bringup robot_vision_cameras_bringup.launch.py camera:=zed_m camera:=ip_cam use_zed_hardware:=false yolo_model:=yolov8l.pt yolo_model:=yolov8s.pt yolo_model:=my_yolo_model.pt";
      ...
      if (mode === "real") {
        ...
        zedBringupCmd = "ros2 launch my_3d_vision_bringup robot_vision_cameras_bringup.launch.py camera:=zed_m camera:=ip_cam use_zed_hardware:=true yolo_model:=yolov8l.pt yolo_model:=yolov8s.pt yolo_model:=my_yolo_model.pt";
      }
    ...
    const CMD_DETAILS = {
      ...
      "ros2 run my_3d_vision_bringup yolo_3d_bbox_for_ip_cam.py": `<div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Included Source Files:</b></div><ul style="padding-left: 16px; margin: 0; font-size: 11px; color: var(--mut); line-height: 1.4;"><li><span class="badge badge-node" style="margin-right: 6px;"><svg viewBox="0 0 100 100" style="width: 10px; height: 10px; margin-right: 4px; vertical-align: -0.15em;" fill="currentColor"><g stroke="currentColor" stroke-width="8"><line x1="61.3" y1="38.7" x2="80" y2="20"/><line x1="39.7" y1="37.7" x2="25" y2="20"/><line x1="34" y1="50" x2="15" y2="50"/><line x1="50" y1="66" x2="50" y2="85"/></g><circle cx="50" cy="50" r="12" fill="none" stroke="currentColor" stroke-width="8"/><circle cx="80" cy="20" r="11" fill="currentColor"/><circle cx="25" cy="20" r="11" fill="currentColor"/><circle cx="15" cy="50" r="11" fill="currentColor"/><circle cx="50" cy="85" r="11" fill="currentColor"/></svg> NODE</span><span style="color: var(--c-node); font-size: 1.7em; font-weight: normal;"> yolo_3d_bbox_for_ip_cam</span> <span style="float: right; opacity: 0.7;">(my_3d_vision_bringup)</span></li></ul>`,
