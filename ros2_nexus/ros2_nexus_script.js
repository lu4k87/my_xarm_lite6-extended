       ...
       actions.forEach(a => {
           ...
           if (expandedWhole) {
               ...
               if (match) {
                   ...
                   html += `<li data-raw-cmd="${a.cmd.replace(/"/g, '&quot;')}"><span class="badge badge-sys" style="margin-right: 6px;">CMD</span><span style="color: var(--c-cmd); font-size: 1.7em; font-weight: normal;">${a.cmd}</span></li>`;
               }
           ...
           subCmds.forEach(subCmd => {
               ...
               if (expanded) {
                   ...
                   if (match) {
                       ...
                       html += `<li data-raw-cmd="${subCmd.replace(/"/g, '&quot;')}"><span class="badge badge-sys" style="margin-right: 6px;">CMD</span><span style="color: var(--c-cmd); font-size: 1.7em; font-weight: normal;">${subCmd}</span></li>`;
                   }
               } else if (subCmd.startsWith('(google-chrome') || subCmd.startsWith('google-chrome')) {
                   if (!a.cmd.includes('http.server')) {
                       html += `<li data-raw-cmd="${subCmd.replace(/"/g, '&quot;')}"><span class="badge badge-server" style="margin-right: 6px;"><i class="fa-solid fa-globe"></i>WEB</span><span class="badge" style="background: rgba(66, 133, 244, 0.15); color: #4285F4; border: 1px solid rgba(66, 133, 244, 0.3); margin-right: 6px;"><i class="fa-brands fa-chrome" style="margin-right: 4px;"></i>+CHROME</span><span style="color: var(--c-cmd); font-size: 1.7em; font-weight: normal;"> Chrome Browser</span> <span style="float: right; opacity: 0.7;">(Frontend)</span></li>`;
                   }
               } else {
                   let badge = subCmd.startsWith('ros2 launch') ? `<span class="badge badge-launch" style="margin-right: 6px;"><i class="fa-solid fa-rocket" style="margin-right: 4px;"></i>LAUNCH</span><span style="color: var(--c-launch); font-size: 1.7em; font-weight: normal;">` : `<span class="badge badge-node" style="margin-right: 6px;"><svg viewBox="0 0 100 100" style="width:10px;height:10px;margin-right:4px;vertical-align:-0.15em;" fill="currentColor"><g stroke="currentColor" stroke-width="8"><line x1="61.3" y1="38.7" x2="80" y2="20"/><line x1="39.7" y1="37.7" x2="25" y2="20"/><line x1="34" y1="50" x2="15" y2="50"/><line x1="50" y1="66" x2="50" y2="85"/></g><circle cx="50" cy="50" r="12" fill="none" stroke="currentColor" stroke-width="8"/><circle cx="80" cy="20" r="11" fill="currentColor"/><circle cx="25" cy="20" r="11" fill="currentColor"/><circle cx="15" cy="50" r="11" fill="currentColor"/><circle cx="50" cy="85" r="11" fill="currentColor"/></svg> NODE</span><span style="color: var(--c-node); font-size: 1.7em; font-weight: normal;">`;
                   ...
                   if (subCmd.includes('http.server')) {
                       ...
                       badge = `<span class="badge badge-server" style="margin-right: 6px;"><i class="fa-solid fa-server" style="margin-right: 4px;"></i>SERVER</span>${chromeBadgeStr}<span style="color: var(--c-cmd); font-size: 1.7em; font-weight: normal;">`;
