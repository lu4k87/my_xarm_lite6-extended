    ...
    function renderTab(tabId) {
      ...
      let colHtml = [
        '<div class="col-wrapper" style="flex: 1; display: flex; flex-direction: column; position: relative;"><h2 style="text-align: center; color: rgba(255,255,255,0.9); font-size: 22px; font-weight: 900; letter-spacing: 3px; margin-bottom: 15px; margin-top: 0; text-transform: uppercase;">Full Setups</h2><div style="height: 1px; background: rgba(255,255,255,0.1); margin: 0 40px 30px 40px;"></div><div class="col" id="col-0" style="flex: 1;">',
        '<div class="col-wrapper" style="flex: 1; display: flex; flex-direction: column; position: relative;"><h2 style="text-align: center; color: rgba(255,255,255,0.9); font-size: 22px; font-weight: 900; letter-spacing: 3px; margin-bottom: 15px; margin-top: 0; text-transform: uppercase;">Single Nodes</h2><div style="height: 1px; background: rgba(255,255,255,0.1); margin: 0 40px 30px 40px;"></div><div class="col" id="col-1" style="flex: 1;">',
        '<div class="col-wrapper" style="flex: 1; display: flex; flex-direction: column; position: relative;"><h2 style="text-align: center; color: rgba(255,255,255,0.9); font-size: 22px; font-weight: 900; letter-spacing: 3px; margin-bottom: 15px; margin-top: 0; text-transform: uppercase;">Web/-Server and more</h2><div style="height: 1px; background: rgba(255,255,255,0.1); margin: 0 40px 30px 40px;"></div><div class="col" id="col-2" style="flex: 1;">'
      ];
