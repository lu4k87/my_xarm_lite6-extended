    ...
    async function runDevSetup(mode) {
      ...
      const actions = [
        ...
        { cmd: "ros2 launch whisper_bringup bringup.launch.py silero_vad_use_cuda:=True use_gpu:=True device_index:=10", title: "Whisper Bringup (Voice AI)" },
    ...
    const CMD_DETAILS = {
      ...
      "ros2 launch whisper_bringup bringup.launch.py silero_vad_use_cuda:=True use_gpu:=True device_index:=10": `<div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Included Source Files:</b></div><ul style="padding-left: 16px; margin: 0; font-size: 11px; color: var(--mut); line-height: 1.4;"><li><span style="color: var(--c-launch);">bringup.launch.py</span> <span style="float: right; opacity: 0.7;">(Main)</span><ul style="padding-left: 16px; margin: 2px 0 0 0;"><li><span style="color: var(--accent);">audio_listener.py</span> <span style="float: right; opacity: 0.7;">(Mic Stream)</span></li><li><span style="color: var(--accent);">inference.cpp</span> <span style="float: right; opacity: 0.7;">(Whisper C++ Engine)</span></li></ul></li></ul>`,
            ...
            <div class="card-wrapper">
              ...
              <div class="card-tooltip">
                ...
                <ul style="padding-left: 16px; margin: 0; font-size: 11px; color: var(--mut); line-height: 1.4;">
                   ...
                   <li><span style="color: var(--accent);">pointcloud_tf_tuner.py</span> <span style="float: right; opacity: 0.7;">(TF Tuner)</span></li>
