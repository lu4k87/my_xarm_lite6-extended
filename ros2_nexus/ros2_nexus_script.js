    ...
    const CMD_DETAILS = {
      ...
      "ros2 launch motion_sequence motion_sequence_launch.py": `<div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Included Source Files:</b></div><ul style="padding-left: 16px; margin: 0; font-size: 11px; color: var(--mut); line-height: 1.4;"><li><span style="color: var(--c-node);">motion_sequence_launch.py</span> <span style="float: right; opacity: 0.7;">(Main)</span><ul style="padding-left: 16px; margin: 2px 0 0 0;"><li><span style="color: var(--c-node);">motion_sequence.py</span> <span style="float: right; opacity: 0.7;">(Sequencer)</span></li></ul></li></ul>`,
      "ros2 launch rviz_marker_static_scene_objects rviz_marker_static_scene_objects.launch.py": `<div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Included Source Files:</b></div><ul style="padding-left: 16px; margin: 0; font-size: 11px; color: var(--mut); line-height: 1.4;"><li><span style="color: var(--c-launch);">rviz_marker_static_scene_objects.launch.py</span> <span style="float: right; opacity: 0.7;">(Main)</span><ul style="padding-left: 16px; margin: 2px 0 0 0;"><li><span style="color: var(--c-node);">rviz_marker_static_scene_objects.py</span> <span style="float: right; opacity: 0.7;">(Statische RViz Marker)</span></li></ul></li></ul>`,
      "ros2 launch rosbridge_server rosbridge_websocket_launch.xml": `<div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Included Source Files:</b></div><ul style="padding-left: 16px; margin: 0; font-size: 11px; color: var(--mut); line-height: 1.4;"><li><span style="color: var(--c-launch);">rosbridge_websocket_launch.xml</span> <span style="float: right; opacity: 0.7;">(Main)</span><ul style="padding-left: 16px; margin: 2px 0 0 0;"><li><span style="color: var(--c-node);">rosbridge_websocket.py</span> <span style="float: right; opacity: 0.7;">(WebSocket Server Port 9090)</span></li><li><span style="color: var(--c-node);">rosapi_node.py</span> <span style="float: right; opacity: 0.7;">(ROS API Service)</span></li></ul></li></ul>`,
      // ── Node Commands ───────────────────────────────────────────────────────
      "ros2 run collision_check checker": `<div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Package:</b> <span style="color: var(--c-node);">collision_check</span></div><div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Executable:</b> <span style="color: var(--c-node);">checker</span></div><div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Source File:</b> <span style="color: var(--c-node);">checker.py</span></div>`,
      "ros2 run voice_command_listener listener": `<div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Package:</b> <span style="color: var(--c-node);">voice_command_listener</span></div><div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Executable:</b> <span style="color: var(--c-node);">listener</span></div><div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Source File:</b> <span style="color: var(--c-node);">voice_command_listener.py</span></div>`,
      "ros2 run move_to_coordinator move_to_coordinator": `<div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Package:</b> <span style="color: var(--c-node);">move_to_coordinator</span></div><div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Executable:</b> <span style="color: var(--c-node);">move_to_coordinator</span></div><div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Source File:</b> <span style="color: var(--c-node);">move_to_coordinator.py</span></div>`,
      "ros2 run gaze_control gaze_ui": `<div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Package:</b> <span style="color: var(--c-node);">gaze_control</span></div><div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Executable:</b> <span style="color: var(--c-node);">gaze_ui</span></div><div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Source File:</b> <span style="color: var(--c-node);">gaze_ui_node_tobii_glasses.py</span></div>`,
      "ros2 run whisper_demos whisper_on_key": `<div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Package:</b> <span style="color: var(--c-node);">whisper_demos</span></div><div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Executable:</b> <span style="color: var(--c-node);">whisper_on_key</span></div><div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Source File:</b> <span style="color: var(--c-node);">stream.py</span></div>`,
      ...
      "ros2 run rviz_servo_status_overlay servo_status_overlay": `<div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Package:</b> <span style="color: var(--c-node);">rviz_servo_status_overlay</span></div><div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Executable:</b> <span style="color: var(--c-node);">servo_status_overlay</span></div><div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Source File:</b> <span style="color: var(--c-node);">servo_status_overlay.py</span></div>`,
      "ros2 run yolo_object_detector yolo_homography_node": `<div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Package:</b> <span style="color: var(--c-node);">yolo_object_detector</span></div><div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Executable:</b> <span style="color: var(--c-node);">yolo_homography_node</span></div><div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Source File:</b> <span style="color: var(--c-node);">yolo_homography_node.py</span></div>`,
      "ros2 run my_3d_vision_bringup yolo_grasp_executor.py": `<div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Package:</b> <span style="color: var(--c-node);">my_3d_vision_bringup</span></div><div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Executable:</b> <span style="color: var(--c-node);">yolo_grasp_executor.py</span></div><div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Source File:</b> <span style="color: var(--c-node);">yolo_grasp_executor.py</span></div>`,
      ...
      "ros2 run linear_axis_tuner linear_axis_tuner": `<div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Package:</b> <span style="color: var(--c-node);">linear_axis_tuner</span></div><div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Executable:</b> <span style="color: var(--c-node);">linear_axis_tuner</span></div><div style="font-size: 11px; color: var(--mut); margin-bottom: 4px;"><b>Source File:</b> <span style="color: var(--c-node);">linear_axis_tuner_node.py</span></div>`
    };
              ...
              <div class="card-tooltip">
                ...
                <ul style="padding-left: 16px; margin: 0; font-size: 11px; color: var(--mut); line-height: 1.4;">
                   ...
                   <li><span style="color: var(--c-launch);">rviz_marker_static_scene_objects.launch.py</span> <span style="float: right; opacity: 0.7;">(Main)</span>
                     <ul style="padding-left: 16px; margin: 2px 0 4px 0;">
                       <li><span style="color: var(--c-node);">rviz_marker_static_scene_objects.py</span> <span style="float: right; opacity: 0.7;">(Static Markers)</span></li>
                     </ul>
                   </li>
                   ...
                   <li><span style="color: var(--c-node);">servo_status_overlay.py</span> <span style="float: right; opacity: 0.7;">(RViz Overlay)</span></li>
                   <li><span style="color: var(--c-launch);">zed_cam_rviz_pointcloud_tf_yolo_planned_grasp.launch.py</span> <span style="float: right; opacity: 0.7;">(Vision Bringup)</span>
                     <ul style="padding-left: 16px; margin: 2px 0 4px 0;">
                       ...
                       <li><span style="color: var(--c-node);">zed_stand_publisher.py</span> <span style="float: right; opacity: 0.7;">(Stativ Marker)</span></li>
                       <li><span style="color: var(--c-node);">pointcloud_optimizer.py</span> <span style="float: right; opacity: 0.7;">(PointCloud Filter)</span></li>
                       <li><span style="color: var(--c-node);">yolo_moveit_collision.py</span> <span style="float: right; opacity: 0.7;">(YOLO Collision)</span></li>
                       <li><span style="color: var(--c-node);">zed_yolo_3d_bbox.py</span> <span style="float: right; opacity: 0.7;">(YOLO BBox)</span></li>
                       <li><span style="color: var(--c-node);">yolo_planned_grasp_executor.py</span> <span style="float: right; opacity: 0.7;">(Grasp Executor)</span></li>
                       <li><span style="color: var(--c-node);">grasp_action_bridge.py</span> <span style="float: right; opacity: 0.7;">(Action Bridge)</span></li>
                     </ul>
                   </li>
                   <li><span style="color: var(--c-launch);">bringup.launch.py</span> <span style="float: right; opacity: 0.7;">(Whisper Bringup)</span>
                     <ul style="padding-left: 16px; margin: 2px 0 4px 0;">
                       <li><span style="color: var(--c-node);">audio_listener.py</span> <span style="float: right; opacity: 0.7;">(Mic Stream)</span></li>
                       <li><span style="color: var(--c-node);">inference.cpp</span> <span style="float: right; opacity: 0.7;">(Whisper Engine)</span></li>
                     </ul>
                   </li>
                   <li><span style="color: var(--c-node);">voice_command_listener.py</span> <span style="float: right; opacity: 0.7;">(Voice Controller)</span></li>
                   <li><span style="color: var(--c-launch);">rosbridge_websocket_launch.xml</span> <span style="float: right; opacity: 0.7;">(ROS Bridge)</span>
                     <ul style="padding-left: 16px; margin: 2px 0 4px 0;">
                       <li><span style="color: var(--c-node);">rosbridge_websocket.py</span> <span style="float: right; opacity: 0.7;">(WebSocket Server)</span></li>
                       <li><span style="color: var(--c-node);">rosapi_node.py</span> <span style="float: right; opacity: 0.7;">(ROS API)</span></li>
                     </ul>
                   </li>
            ...
            <div class="card-wrapper">
              ...
              <div class="card-tooltip">
                ...
                <ul style="padding-left: 16px; margin: 0; font-size: 11px; color: var(--mut); line-height: 1.4;">
                   ...
                   <li><span style="color: var(--c-node);">checker.py</span> <span style="float: right; opacity: 0.7;">(Collision Checker)</span></li>
                   <li><span style="color: var(--c-launch);">rosbridge_websocket_launch.xml</span> <span style="float: right; opacity: 0.7;">(ROS Bridge)</span>
                     <ul style="padding-left: 16px; margin: 2px 0 4px 0;">
                       <li><span style="color: var(--c-node);">rosbridge_websocket.py</span> <span style="float: right; opacity: 0.7;">(WebSocket Server)</span></li>
                       <li><span style="color: var(--c-node);">rosapi_node.py</span> <span style="float: right; opacity: 0.7;">(ROS API)</span></li>
                   ...
                   <li><span style="color: var(--c-cmd);">servo.rviz</span> <span style="float: right; opacity: 0.7;">(RViz2 Operator View)</span></li>
            ...
            <div class="card-wrapper">
              ...
              <div class="card-tooltip">
                ...
                <ul style="padding-left: 16px; margin: 0; font-size: 11px; color: var(--mut); line-height: 1.4;">
                   ...
                   <li><span style="color: var(--c-cmd);">robot_control_web_ui</span> <span style="float: right; opacity: 0.7;">(Web Server)</span></li>
                   <li><span style="color: var(--c-node);">web_video_server</span> <span style="float: right; opacity: 0.7;">(ROS Video Stream :8082)</span></li>
                   <li><span style="color: var(--c-node);">gaze_ui_node_tobii_glasses.py</span> <span style="float: right; opacity: 0.7;">(Gaze UI Glasses 3 Pro)</span></li>
                </ul>
              </div>
            </div>
          </div>
