    ...
    function injectOptBadges(htmlStr) {
        ...
        for (const nodeName of OPT_NODES) {
            ...
            res = res.replace(pattern, optBadgeHtml + '$1');
        }
        return res;
    }
           ...
           // 1. Direct or prefix lookup in CMD_DETAILS
            ...
            if (subCmds.length > 1) {
               ...
               if (!primaryHtml) {
                   ...
                   const badgeCls = isLaunch ? "badge-launch" : "badge-node";
                   const badgeIcon = isLaunch ? '<i class="fa-solid fa-rocket" style="margin-right: 4px;"></i>LAUNCH' : 'NODE';
               ...
               for (let i = 1; i < subCmds.length; i++) {
                   ...
                   let scTerm = sc;
                   let scBadge = `<span class="badge badge-node" style="margin-right: 6px;">NODE</span>`;
                   let scColor = 'var(--c-node)';
