...
static const _AudioTranscript_type_support_symbol_names_t _AudioTranscript_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, whisper_idl, msg, AudioTranscript)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, whisper_idl, msg, AudioTranscript)),
  }
};
...
{
  return &::whisper_idl::msg::rosidl_typesupport_cpp::AudioTranscript_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, whisper_idl, msg, AudioTranscript)() {
  return get_message_type_support_handle<whisper_idl::msg::AudioTranscript>();
}
