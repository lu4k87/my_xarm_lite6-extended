...
#define NODE_MAIN_LOGGER_NAME "transcript_manager_comp"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtranscript_manager_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<whisper::TranscriptManager>";
