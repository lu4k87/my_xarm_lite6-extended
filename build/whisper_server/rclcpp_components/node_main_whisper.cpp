...
#define NODE_MAIN_LOGGER_NAME "whisper"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libinference_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<whisper::Inference>";
