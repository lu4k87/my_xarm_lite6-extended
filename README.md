...
2. [🔬 Architecture & Guiding Principles](#🔬-architecture-guiding-principles)
...
3. [⚙️ Core Features & ROS 2 Nodes](#⚙️-core-features-ros-2-nodes)
   ...
   - [🗣️ 3.4 Feature: Multimodal Interaction (Voice & Gaze Control)](#🗣️-34-feature-multimodal-interaction-voice-gaze-control)
   - [🖥️ 3.5 Feature: Graphical Control & Visual Feedback](#🖥️-35-feature-graphical-control-visual-feedback)
   - [🌌 3.6 Feature: Digital Twin & Simulation (NVIDIA Isaac Sim)](#🌌-36-feature-digital-twin-simulation-nvidia-isaac-sim)

4. [🎮 Gamepad Control — Deep Dive](#🎮-gamepad-control-—-deep-dive)
   - [4.1 Pipeline Architecture](#41-pipeline-architecture)
   - [4.2 `checker.py` — Collision Guard (Python Node)](#42-checkerpy-—-collision-guard-python-node)
...
6. [🚀 Execution: How to Run the System](#🚀-execution-how-to-run-the-system)
   - [6.1 Step 1: Hardware Preparation](#61-step-1-hardware-preparation)
   ...
   - [6.7 Launcher Configuration (`launcher_config.json`)](#67-launcher-configuration-launcherconfigjson)
...
7. [📊 Monitoring: Dashboard & Workspace Analyzer](#📊-monitoring-dashboard-workspace-analyzer)
   ...
   - [7.3 Launch Commands for UI Components](#73-launch-commands-for-ui-components)
8. [🕹️ Multimodal Technologies & Interaction Concepts](#🕹️-multimodal-technologies-interaction-concepts)
   - [8.1 Robot Control Methods (Inputs)](#81-robot-control-methods-inputs)
   - [8.2 Perception & Assistance](#82-perception-assistance)
   - [8.4 User Interfaces (UI/GUI)](#84-user-interfaces-uigui)
9. [🗂️ Repository Structure](#🗂️-repository-structure)
10. [🗄️ Archive / Deprecated Concepts](#🗄️-archive-deprecated-concepts)
