...
> - **Activation:** Use the launch parameter `use_linear_axis:=true`.
> - **Control:** Start `ros2 run linear_axis_tuner linear_axis_tuner` to move the robot base horizontally via a GUI slider.
