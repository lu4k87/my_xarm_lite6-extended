...
def launch_setup(context, *args, **kwargs):
    ...
    # Static Transform: Kamera ist auf 60cm Höhe (--z 0.6) und schaut 45 Grad nach unten (--pitch 0.78539).
    # Roll ist jetzt strikt 0, damit sie nicht mehr auf dem Kopf steht!
    static_tf_node = Node(
        package='tf2_ros',
    ...
    zed_wrapper_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'param_overrides': 'pos_tracking.base_frame:=base_link'
        }.items(),
