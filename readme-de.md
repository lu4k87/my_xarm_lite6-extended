...
>
> ⚠️ **Troubleshooting:**
> - **Nur fliegende Sterne in VR?** → Der Browser lädt noch alte, gecachte Seiten ohne `XRWebGLLayer`. Zwinge den Browser zum Neuladen mit einem Parameter: `https://<PC-IP>:8443/controller_reader.html?v=1`.
